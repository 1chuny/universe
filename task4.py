...
# ==========================================
n = 32
COHORTS_TO_PREDICT = list(range(17, 21))
FORECAST_WEEKS = 52
# ==========================================
...
def run_forecast():
    ...
    for cohort_id in COHORTS_TO_PREDICT:
        ...
        total_rev = total_actual_rev + projected_rev
        total_period_rev += total_rev
        ...
        results.append({
            ...
            'Дохід разом із прогнозом': round(total_rev, 4)
        })
    ...
    print("\n" + "=" * 50)
    print(f"ЗАРОБІТОК ДЛЯ КОГОРТ {min(COHORTS_TO_PREDICT)}-{max(COHORTS_TO_PREDICT)}:")
    print(f"Компанія заробила за період {FORECAST_WEEKS} тижнів: {total_period_rev:.2f}$")
    print("=" * 50)
